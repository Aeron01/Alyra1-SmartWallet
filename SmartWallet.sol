...
contract SmartWallet is Ownable {
    ...
    function approve(address spender, uint256 amount) public {
        require(owner != address(0),"allowed");
        require(spender != address(0),"allowed");
    ...
    function transferFrom(address from, address to, uint256 amount) public {
        require(_allowances[from][msg.sender] >= amount,"SmartWallet: You don't have any funds allowed anymore.");
